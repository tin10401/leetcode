<h2><a href="https://leetcode.com/problems/count-substrings-that-satisfy-k-constraint-ii">Count Substrings That Satisfy K-Constraint II</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given a <strong>binary</strong> string <code>s</code> and an integer <code>k</code>.</p>
